...
const XTwitterLogo = () => {
  return (
    <svg
      ...
      height="300"
      viewBox="0 0 300 300"
      className="p-px h-4 w-4 text-zinc-500 transition-colors group-hover:text-white"
    >
      <path
        fill="currentColor"
        ...
        <div className="flex flex-col gap-16 py-24 md:py-32 lg:flex-row lg:gap-16">
          ...
          <div className="flex flex-col gap-6 lg:w-64 lg:shrink-0">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-zinc-400">
              The ultimate link-in-bio platform for creators. Delightfully
              simple, delightfully fast.
            </p>
            <Link
              href="/i/auth/signup"
              className="inline-flex w-fit rounded-full bg-white px-5 py-2.5 text-sm font-semibold text-zinc-900 transition-colors hover:bg-zinc-200"
            >
              Get started free
            </Link>
