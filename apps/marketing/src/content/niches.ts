...
const NICHES: NicheContent[] = [
...

  {
    ...
    faqs: [
      {
        question:
          'Does the Instagram Latest Post block show my most recent photo automatically?',
        answer:
      ...
      {
        question:
          'Can I pin a specific image that is not my latest Instagram post?',
        answer:
      ...
      {
        question:
          'Can I link to my portfolio website and booking form at the same time?',
        answer:
      ...
      {
        question:
          'Does Linky work for both personal and studio photographer accounts?',
        answer:
...

  {
    ...
    faqs: [
      {
        question:
          'Can I link to multiple podcast directories from one Linky page?',
        answer:
      ...
      {
        question:
          'How do I keep my Linky page up to date as I release new episodes?',
        answer:
...

  {
    ...
    faqs: [
      ...
      {
        question:
          'Will my Linky page update automatically when I post on Instagram?',
        answer:
...

  {
    ...
    faqs: [
      {
        question:
          'Can I show my latest Instagram and TikTok posts on the same page?',
        answer:
...

  {
    ...
    faqs: [
      {
        question:
          'Can I show my restaurant address and directions on my Linky page?',
        answer:
      ...
      {
        question:
          'Can I link to multiple food delivery apps from the same page?',
        answer:
...

  {
    ...
    faqs: [
      ...
      {
        question:
          'Can I feature different stylists with their own booking links?',
        answer:
...

  {
    ...
    faqs: [
      ...
      {
        question:
          'Can I highlight a specific listing with an image on my Linky page?',
        answer:
      ...
      {
        question:
          'Is Linky suitable for both buyers agents and selling agents?',
        answer:
...

  {
    ...
    faqs: [
      {
        question:
          'Can I display writing samples or a bio directly on my Linky page?',
        answer:
      ...
      {
        question:
          'Can I link to my published articles across multiple outlets?',
        answer:
      ...
      {
        question:
          'Can I use Linky as my main author web presence without a separate website?',
        answer:
...

  {
    ...
    faqs: [
      ...
      {
        question:
          'Can I link to specific GitHub repositories rather than my full profile?',
        answer:
      ...
      {
        question:
          'Can I display a technical bio or list my tech stack on my Linky page?',
        answer:
...

  {
    ...
    faqs: [
      ...
      {
        question:
          'Does the Instagram Latest Post block show Reels and carousels too?',
        answer:
      ...
      {
        question:
          'Is Linky suitable for both solo designers and design studios?',
        answer:
...

  {
    ...
    faqs: [
      ...
      {
        question:
          'Can I collect email addresses from prospective clients on Linky?',
        answer:
      ...
      {
        question:
          'Can I write about my coaching methodology directly on the page?',
        answer:
      ...
      {
        question:
          'Is Linky suitable for group coaching programmes and 1:1 coaching simultaneously?',
        answer:
...
export const getNiche = (slug: string) =>
  niches.find((n) => n.slug === slug) ?? null;
